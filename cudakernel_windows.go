...
var (
	//kernelDll           = syscall.MustLoadDLL("bitum.dll")
	kernelDll               = syscall.MustLoadDLL("bitum.dll")
	precomputeTableProcAddr = kernelDll.MustFindProc("bitum_cpu_setBlock_52").Addr()
	kernelProcAddr          = kernelDll.MustFindProc("bitum_hash_nonce").Addr()
)

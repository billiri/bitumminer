...
import (
	...
	"github.com/bitum-project/bitumminer/nvml"
	"github.com/bitum-project/bitumminer/util"
	"github.com/bitum-project/bitumminer/work"
)
...
func bitumCPUSetBlock52(input *[192]byte) {
	if input == nil {
		panic("input is nil")
	}
...
func bitumHashNonce(gridx, blockx, threads uint32, startNonce uint32, nonceResults cu.DevicePtr, targetHigh uint32) {
...
func (d *Device) runDevice() error {
	...
	for {
		...
		bitumHashNonce(gridx, blockx, throughput, startNonce, nonceResultsD, targetHigh)

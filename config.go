...
const (
	defaultConfigFilename = "bitumminer.conf"
	defaultLogLevel       = "info"
	defaultLogDirname     = "logs"
	defaultLogFilename    = "bitumminer.log"
	defaultClKernel       = "blake256.cl"
)

var (
	minerHomeDir          = bitumutil.AppDataDir("bitumminer", false)
	bitumdHomeDir           = bitumutil.AppDataDir("bitumd", false)
	defaultConfigFile     = filepath.Join(minerHomeDir, defaultConfigFilename)
	defaultRPCServer      = "localhost"
	defaultRPCCertFile    = filepath.Join(bitumdHomeDir, "rpc.cert")
